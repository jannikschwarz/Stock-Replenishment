...
I have seeded the application with some data but currently the only real functional way of interacting with the API is utilizing swagger "[localhost:5273/swagger](http://localhost:5273/swagger/index.html)". 
This is because I sadly have to admit I have not yet coded with Mudblazor and only known Razor in of itself. 
